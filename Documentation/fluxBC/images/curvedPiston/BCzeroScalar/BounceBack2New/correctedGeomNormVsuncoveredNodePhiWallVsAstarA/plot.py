...
cases = ['wrong normal','correct normal','phi wall']

os.chdir('../../AstarA/run/')
import AstarA as case0
os.chdir('../../CorrectedGeomNorm/run/')
import correctedGeomNorm as case1
os.chdir('../../uncoveredNodePhiWall/run/')
import uncoveredNodePhiWall as case2
os.chdir('../../plots/correctedGeomNormVsuncoveredNodePhiWallVsAstarA')
...
plt.plot(case2.time, (case2.phiOUTleft-case2.phiINleft)*1e6,'-', color= 'blue', label=cases[2])
...
plt.plot(case2.time, (case2.phiOUTright-case2.phiINright)*1e6,'-', color= 'blue', label=cases[2])
plt.grid(b=True, which='major',  axis='y', linewidth=1)
#plt.xlim(0,750)
plt.xlabel('Time(s)')
...
plt.plot(case2.time, (case2.phiOUTright-case2.phiINright)*1e6-(case2.phiOUTleft-case2.phiINleft)*1e6 ,'-', color= 'blue', label=cases[2])
plt.grid(b=True, which='major',  axis='y', linewidth=1)
#plt.xlim(0,750)
plt.xlabel('Time (s)')
...
plt.plot(case2.time, case2.scalarAbsorbed,'-', color= 'blue', label=cases[2])
plt.grid(b=True, which='major',  axis='y', linewidth=1)
#plt.xlim(0,2.3)
plt.xlabel('Time (s)')
...
plt.plot(case2.time, case2.scalarRemained,'-', color= 'blue', label=cases[2])
plt.grid(b=True, which='major',  axis='y', linewidth=1)
#plt.xlim(0,2.3)
plt.xlabel('Time (s)')
...
plt.plot(case2.time, case2.scalarError,'-', color= 'blue', label=cases[2])
plt.grid(b=True, which='major',  axis='y', linewidth=1)
#plt.xlim(0,2.3)
plt.xlabel('Time (s)')
